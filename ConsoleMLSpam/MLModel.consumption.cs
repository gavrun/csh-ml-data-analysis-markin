...
namespace ConsoleMLSpam
{
    public partial class MLModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("IsSpam");
            if (labelColumn == null)
            {
                throw new Exception("IsSpam column not found. Make sure the name searched for matches the name in the schema.");
            }
