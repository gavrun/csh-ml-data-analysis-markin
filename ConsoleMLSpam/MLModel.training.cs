...
namespace ConsoleMLSpam
{
    ...
    {
        public const string RetrainFilePath =  @"C:\itmo\09\csh-ml-data-analysis-markin\ConsoleMLSpam\Data\email_dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"IsSpam",inputColumnName:@"IsSpam",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"IsSpam", sentence1ColumnName: @"Content"))      
